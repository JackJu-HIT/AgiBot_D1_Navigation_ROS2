#ifndef TEB_TEB_CONFIG_H
#define TEB_TEB_CONFIG_H
    ...
    public:
        ...
        */
        TebConfig()
        {
            ...
            trajectory.global_plan_viapoint_sep = -0.1;
            trajectory.via_points_ordered = false;
            trajectory.max_global_plan_lookahead_dist = 2.0;
            trajectory.global_plan_prune_distance = 1;
            trajectory.exact_arc_length = false;
            trajectory.force_reinit_new_goal_dist = 1.0;
            ...
            obstacles.dynamic_obstacle_inflation_dist = 0.7;
            obstacles.include_dynamic_obstacles = true;
            obstacles.include_costmap_obstacles = true;
            obstacles.costmap_obstacles_behind_robot_dist = 0.8;
            obstacles.obstacle_poses_affected = 10;//25;
            ...
            optim.weight_max_vel_theta = 3;
            optim.weight_acc_lim_x = 1;
            optim.weight_acc_lim_y = 1;
            optim.weight_acc_lim_theta = 2;
            optim.weight_kinematics_nh = 3000;
            optim.weight_kinematics_forward_drive = 1000;
            optim.weight_kinematics_turning_radius = 1;
            optim.weight_optimaltime = 2;
            optim.weight_shortest_path = 1;
            ...
            optim.weight_adapt_factor = 1;
            optim.obstacle_cost_exponent = 2;
