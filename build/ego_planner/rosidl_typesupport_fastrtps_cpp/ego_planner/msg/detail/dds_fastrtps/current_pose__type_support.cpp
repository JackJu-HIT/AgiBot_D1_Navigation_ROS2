...
#include "ego_planner/msg/detail/current_pose__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ego_planner::msg::CurrentPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ego_planner::msg::CurrentPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ego_planner::msg::CurrentPose *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ego_planner
const rosidl_message_type_support_t *
get_message_type_support_handle<ego_planner::msg::CurrentPose>()
{
  return &ego_planner::msg::typesupport_fastrtps_cpp::_CurrentPose__handle;
}
